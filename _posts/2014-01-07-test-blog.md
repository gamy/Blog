...
<p class="meta">2014-02-07 - 广州</p>



{% highlight ruby %}

- (void)test:(NSString *)str print:(NSInteger)intVal
{
	NSLog([NSString stringWithFormat:@"%@, %d",str, intVal]);
}
...
<a href=http://news.ycombinator.com/item?id=3267432 >Discuss this post on Hacker News </a>
